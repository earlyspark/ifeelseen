        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 p-4 sm:p-6">
          <div className="mx-auto max-w-2xl rounded-lg border border-white/10 bg-[#1a1a1a] p-4 sm:flex sm:items-center sm:justify-between sm:gap-6">
            <p className="text-sm text-white/60">
              ...
              <span className="text-white/80">No personal data is stored.</span>
            </p>
            <div className="mt-3 flex shrink-0 gap-3 sm:mt-0">
              ...
              <button
                onClick={accept}
                className="rounded border border-[#c9a84c]/30 bg-[#c9a84c]/20 px-4 py-1.5 text-sm font-medium text-[#c9a84c] transition-colors hover:bg-[#c9a84c]/30"
              >
                Accept
              </button>
            </div>
